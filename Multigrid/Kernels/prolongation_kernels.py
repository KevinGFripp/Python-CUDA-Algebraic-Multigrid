...
def prolongation(x: ndarray,x_coarse: ndarray, Nx: int, Ny: int, Nx_2h: int, Ny_2h: int):
    ...
    if (Nx % 2 == 0) and (Ny % 2 == 0):
        prolongation_2d_4pt(x,x_coarse,Nx,Ny,Nx_2h,Ny_2h)

    if (Nx % 2 != 0) and (Ny % 2 == 0):
        prolongation_2d_4pt_3pt(x,x_coarse,Nx,Ny,Nx_2h,Ny_2h)

    if (Nx % 2 == 0) and (Ny % 2 != 0):
        prolongation_2d_3pt_4pt(x,x_coarse,Nx,Ny,Nx_2h,Ny_2h)

    if (Nx % 2 != 0) and (Ny % 2 != 0):
        prolongation_2d_3pt(x,x_coarse,Nx,Ny,Nx_2h,Ny_2h)
